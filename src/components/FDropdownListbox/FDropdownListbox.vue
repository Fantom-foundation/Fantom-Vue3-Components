...
import { copyMethods, valueOrNull } from '../../utils/vue-helpers.js';
...
export default {
    ...
    // mixins: [FListbox, popoverAnimationMixin],
    mixins: [FSelect, formInputMixin, popoverAnimationMixin],

    emits: ['window-hide', 'selected', 'component-change', 'update:value'],
    ...
    methods: {
        ...copyMethods(FListbox, ['emitChangeEvent']),
