...
export default {
    ...
    emits: ['hamburger-switch-on', 'hamburger-switch-off'],
    ...
    methods: {
        toggle() {
            switchState.value.on = !switchState.value.on;
        ...
        onBreakpointChange() {
            switchState.value.on = false;
        },
    },

    on() {
        switchState.value.on = true;
    },
