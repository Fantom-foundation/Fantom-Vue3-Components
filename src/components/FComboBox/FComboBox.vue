                ...
                <span @click="onButtonClick" data-testcode="fcombobox-button">
                    <slot name="button" v-bind="{ ...sProps, ...slotProps, ...loading }">
                        <FButton
                            ...
                            tertiary
                            round
                            :title="translate('fcombobox.showOptions')"
...
export default {
    ...
    // mixins: [popoverAnimationMixin, translationsMixin, fieldWithButtonMixin, selectMixin, formInputMixin],
    mixins: [popoverAnimationMixin, translationsMixin, selectMixin, formInputMixin],

    emits: ['update:value', 'selected', 'page-change', 'window-hide'],
    ...
    watch: {
        ...
        selectedItem(_value) {
            this.$nextTick(() => {
                ...
                this.$emit('update:value', this.textIsValue ? _value.label : clone(_value.value));
            });
        },
